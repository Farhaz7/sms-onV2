...
<head>
    ...
    <meta
        name="keywords"content="adminkit, bootstrap, bootstrap 5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"integrity="sha384-GLhlTQ8iK9tGR5RVL6ZN7NxFI1u1g3AcCjz0qGwF+6z5lZ6G3UZLI3zqG5FaLJ"
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="d-flex ">
                        <h1 class="h1"><strong>Menu Berkas</strong></h1>
                        <div>
                            <div class="d-flexs">
                                <section>User / Home / Berkas</section>
                            </div>
                        </div>
                    </div>
                    <hr class="mt-0 mb-4">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left">Foto E-KTP yang meninggal dan Bagi anak
                                                    yang belum ber E-KTP bisa diganti dengan akta kelahiran, KIA atau
                                                    surat ket.Lahir dari Bidan / Dokter.</td>
                                                <td style="text-align: center">
                                                    <a href="#" target="_blank"
                                                        class="btn btn-success">Lihat</a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="# target="_blank" class="btn btn-success">Lihat</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="#" target="_blank">&copy;<strong>SMS-ON
                                        2023</strong></a>
                            </p>
                        </div>
                    </div>
