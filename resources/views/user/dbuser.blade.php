                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="#">
                            <i class="align-middle" data-feather="file-plus"></i><span class="align-middle">Tambahkan Berkas</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="syarat">
                            <i class="align-middle" data-feather="file"></i> <span class="align-middle">Syarat - Syarat</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/assets/pdf/PERWALISMS-ON.pdf">
                            <i class="align-middle" data-feather="book"></i> <span class="align-middle">Peraturan Walikota</span>
                        </a>
                    </li>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="d-flex ">
                        <h1 class="h1"><strong>Selamat Datang Di Layanan SMS - ON</strong></h1>
                    <div>
                        <div class="d-flexs">
                            <section>User / Home / Dashboard</section>
                        </div>
                    </div>
                </div>
                <hr class="mt-0 mb-4">
                        ...
                        <div class="col-12 col-lg-8 col-xxl-12">
                            <div class="card flex-fill">
                                <div class="card-header">
                                    <h5 class="card-title">Informasi Pengajuan Anda</h5>
                                </div>
                                <div class="card-body table-responsive">
                                    <table class="table table-hover my-0">
                                        <thead>
                                            <tr>
                                                <th class="data-col1">NIK Yang Meninggal</th>
                                                <th class="data-col1">Nama Yang Meninggal</th>
                                                <th class="data-col1">Nama Ahli Waris</th>
                                                <th class="data-col1">Tanggal Meninggal</th>
                                                <th class="data-col1">Tanggal Pengajuan</th>
                                                <th class="status-col">Status Berkas</th>
                                                <th class="status-col">Status Pengajuan</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="data-col2">{{Auth::user()->nik_meninggal}}</td>
                                                <td class="data-col2">{{Auth::user()->nama_meninggal}}</td>
                                                <td class="data-col2">{{Auth::user()->nama_ahwa}}</td>
                                                <td class="data-col2">
                                                    @if (Auth::user()->tgl_meninggal)
                                                        {{ \Carbon\Carbon::parse(Auth::user()->tgl_meninggal)->isoFormat('D MMMM Y') }}
                                                    @else

                                                    @endif
                                                </td>
                                                <td class="data-col2"></td>
                                                <td class="status-col"><span class="badge bg-danger">Di Tolak</span></td>
                                                <td class="status-col"><span class="badge bg-success">Di Terima</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
