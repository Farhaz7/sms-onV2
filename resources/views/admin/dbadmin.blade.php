        ...
        <div class="main">
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <span class="text-dark">Farhaz</span>
                            </a>
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h1 mb-3"><strong>Selamat Datang Di Layanan SMS - ON</strong></h1>
                    <div class="row">
                            ...
                            <div class="card flex-fill">
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-hover my-0">
                                        <thead>
                                            <tr>
                                                <th class="data-col">NIK Yang Meninggal</th>
                                                <th class="data-col">Nama Yang Meninggal</th>
                                                <th class="data-col">Nama Ahli Waris</th>
                                                <th class="data-col">Tanggal Pengajuan</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="data-col">637512313123141</td>
                                                <td class="data-col">Ucup</td>
                                                <td class="data-col">Salman</td>
                                                <td class="data-col">27/12/2023</td>
                        ...
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://adminkit.io/"
                                    target="_blank">&copy;<strong>SMS-ON</strong></a>
                            </p>
                        </div>
                    </div>
                </div>
